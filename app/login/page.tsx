    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 space-y-6">
      ...
      <Card className="w-full max-w-md p-6 space-y-4">
        <CardHeader>
          ...
          <p className="text-gray-500">Create your own personalized RAG chatbot</p>
        </CardHeader>
        <CardContent>
          ...
          <div className="text-center mt-4">
            <p className="text-gray-500 text-sm">
              New to Aiyou? <Link href="/signup" className="text-blue-600 hover:underline">Create an account</Link>
            </p>
          </div>
        </CardContent>
      </Card>
