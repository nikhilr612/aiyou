...
import { AiOutlineArrowLeft, AiOutlineCaretUp, AiOutlineCaretDown } from "react-icons/ai";
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto flex flex-col items-center justify-between p-6 space-y-6 ">
      ...
      <section className="w-full max-w-7xl text-center space-y-4">
        ...
        <p className="text-lg">
          Find all the resources you need to make the most out of your experience with Aiyou.
        </p>
          ...
          <CardContent className="border-t border-gray-300 pt-3">
            {[
              ...
              },
              {
                ...
                answer: "Navigate to the 'Chat' section in the application and start interacting with the model.",
              },
              {
                question: "What endpoints are supported?",
                answer: "Refer to our API documentation for the list of supported endpoints.",
              },
              {
                question: "Do I need internet access?",
                answer: "Yes, internet access is required to use the service and connect to the models.",
              },
              {
                question: "How do I add a file to the RAG Store?",
                answer: "Go to the 'File Upload' section and upload your file through the provided interface.",
              },
              {
                question: "What file types are supported?",
                answer: "Common file types such as .txt, .pdf, and .docx are supported. Check the documentation for a full list.",
              },
              {
                question: "What is the method used for chunking?",
                answer: "The system uses a smart chunking algorithm that divides text into manageable segments while preserving context.",
              },
              {
                question: "What should I do if chunking fails for my text file?",
                answer: "Ensure the file format is correct and not corrupted. Refer to the troubleshooting guide in the documentation for more details.",
              },
            ].map((faq, index) => (
              <div key={index} className="border-b pb-4">
                ...
                >
                  ...
                  <span className="text-xl">
                    {faqState === index ? <AiOutlineCaretDown /> : <AiOutlineCaretUp />}
                  </span>
                </button>
          ...
          <CardContent className="border-t border-gray-300 pt-3">
            <p>If you need further assistance, please contact our support team:</p>
              <ul className="list-disc ml-6 space-y-2">
                <li>Email: <a href="mailto:support@aiyou.com" className="underline">support@aiyou.com</a></li>
              </ul>
          </CardContent>
        </Card>
      ...
      <footer className="w-full max-w-7xl flex justify-between items-center text-sm text-gray-500 mt-6">
        ...
        <div className="flex space-x-4">
          <Link href="/terms_and_condition" className="underline">Terms of Service</Link>
